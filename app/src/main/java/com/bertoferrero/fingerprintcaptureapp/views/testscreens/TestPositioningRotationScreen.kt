        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                item {
                    ...
                    NumberField<Double>(
                        value = viewModel.cameraController.ransacThresholdMax ?: 0.0,
                        onValueChange = { 
                            viewModel.cameraController.ransacThresholdMax = if (it <= 0.0) null else it 
                        },
                        label = { Text("RTM - Ransac Threshold Max, 0 = disabled") }
                    )
